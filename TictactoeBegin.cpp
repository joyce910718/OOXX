...
void TictactoeBegin::choiceLayingDownPieces() {
	...
	(gameInitialization.getPlayer1_Chessman() == "X") ? offensive = gameInitialization.getPlayer1_Name() : offensive = gameInitialization.getPlayer2_Name();	//進攻者的玩家名稱設給offensive變數
	(gameInitialization.getPlayer1_Chessman() == "O") ? defensive = gameInitialization.getPlayer1_Name() : defensive = gameInitialization.getPlayer2_Name();	//防守方的玩家名稱設給defensive變數
